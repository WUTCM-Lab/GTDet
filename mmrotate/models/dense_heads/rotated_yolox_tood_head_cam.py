...
class RotatedYOLOXHead_tood_cam(YOLOXHead):
    ...
    def _init_layers(self):
        ...
        for _ in self.strides:
            ...
            conv_cls, conv_reg, conv_obj, conv_ang, cls_decomp, reg_decomp = self._build_predictor()
    ...
    def _build_predictor(self):
        ...
        reg_decomp = TaskDecomposition(self.feat_channels,
                                            ...
                                            self.inter_convs * 8,
                                            self.conv_cfg, self.norm_cfg)
        return conv_cls, conv_reg, conv_obj, conv_ang, cls_decomp, reg_decomp
    ...
    def init_weights(self):
        super(RotatedYOLOXHead_tood_cam, self).init_weights()
    ...
    def forward_single(self, x, conv_cls, conv_reg,
                       conv_obj, conv_ang, inter_conv, cls_decomp, reg_decomp):
    ...
    def _get_target_single(self, cls_preds, objectness, priors, decoded_bboxes,
        ...
        return super(RotatedYOLOXHead_tood_cam,
