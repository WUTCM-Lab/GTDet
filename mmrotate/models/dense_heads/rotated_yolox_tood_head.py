...
class RotatedYOLOXHead_tood(YOLOXHead):
    ...
    def init_weights(self):
        super(RotatedYOLOXHead_tood, self).init_weights()
    ...
    def forward_single(self, x, conv_cls, conv_reg,
        ...
        avg_feat = F.adaptive_avg_pool2d(feat, (1, 1))
        cls_feat = cls_decomp(feat, avg_feat)
        reg_feat = reg_decomp(feat, avg_feat)
    ...
    def _get_target_single(self, cls_preds, objectness, priors, decoded_bboxes,
        ...
        return super(RotatedYOLOXHead_tood,
