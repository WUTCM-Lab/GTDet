...
class RotatedYOLOX(RotatedSingleStageDetector):
    ...
    def forward_train(self,
        ...
        losses = super(RotatedYOLOX,
                       self).forward_train(img, img_metas, gt_bboxes,
    ...
    def _preprocess(self, img, gt_bboxes):
        ...
        if scale_x != 1 or scale_y != 1:
            ...
            for gt_bbox in gt_bboxes:
                # center
                gt_bbox[..., 0] = gt_bbox[..., 0] * scale_x
                gt_bbox[..., 1] = gt_bbox[..., 1] * scale_y
                # TODO check if this is correct
                gt_bbox[...,
                        2:4] = gt_bbox[..., 2:4] * math.sqrt(scale_x * scale_y)
