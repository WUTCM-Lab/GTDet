...
def kld_distance(valid_decoded_bbox, gt_bboxes):
    ...
    overlaps = 1 / (1 + dis_agg)
    
    return overlaps

@ROTATED_BBOX_ASSIGNERS.register_module()
class RSimOTAAssigner_kld(SimOTAAssigner):

    def __init__(self, angle_version='le90', **kwargs):
        super(RSimOTAAssigner_kld, self).__init__(**kwargs)
    ...
    def _assign(self,
        ...
        pairwise_ious = -torch.log(pairwise_ious + eps)
    
        iou_cost = (30 / (1 + torch.exp(-5 * (pairwise_ious - 1)))).clamp(max=16)
...
if __name__ == '__main__':
    valid_decoded_bbox =  torch.tensor([[10.0, 10.0, 10.0, 10.0, 0.0],
                                        [11.0, 10.0, 10.0, 10.0, 0.0],
                                        [12.0, 10.0, 10.0, 10.0, 0.0],
                                        [13.0, 10.0, 10.0, 10.0, 0.0],
                                        [14.0, 10.0, 10.0, 10.0, 0.0],
                                        [15.0, 10.0, 10.0, 10.0, 0.0],
                                        [16.0, 10.0, 10.0, 10.0, 0.0],
                                        [17.0, 10.0, 10.0, 10.0, 0.0],
                                        [18.0, 10.0, 10.0, 10.0, 0.0],
                                        [19.0, 10.0, 10.0, 10.0, 0.0],
                                        [20.0, 10.0, 10.0, 10.0, 0.0],
                                        [21.0, 10.0, 10.0, 10.0, 0.0],
                                        [22.0, 10.0, 10.0, 10.0, 0.0],
                                        [23.0, 10.0, 10.0, 10.0, 0.0],
                                        [24.0, 10.0, 10.0, 10.0, 0.0],
                                        [25.0, 10.0, 10.0, 10.0, 0.0]
                                        # [26.0, 10.0, 10.0, 10.0, 0.0],
                                        # [27.0, 10.0, 10.0, 10.0, 0.0],
                                        # [28.0, 10.0, 10.0, 10.0, 0.0],
                                        # [29.0, 10.0, 10.0, 10.0, 0.0],
                                        # [30.0, 10.0, 10.0, 10.0, 0.0],
                                        # [31.0, 10.0, 10.0, 10.0, 0.0],
                                        # [32.0, 10.0, 10.0, 10.0, 0.0],
                                        # [33.0, 10.0, 10.0, 10.0, 0.0],
                                        # [34.0, 10.0, 10.0, 10.0, 0.0],
                                        # [35.0, 10.0, 10.0, 10.0, 0.0],
                                        # [36.0, 10.0, 10.0, 10.0, 0.0],
                                        # [37.0, 10.0, 10.0, 10.0, 0.0],
                                        # [38.0, 10.0, 10.0, 10.0, 0.0],
                                        # [39.0, 10.0, 10.0, 10.0, 0.0],
                                        # [40.0, 10.0, 10.0, 10.0, 0.0],
                                        # [41.0, 10.0, 10.0, 10.0, 0.0],
                                        # [42.0, 10.0, 10.0, 10.0, 0.0],
                                        # [43.0, 10.0, 10.0, 10.0, 0.0],
                                        # [44.0, 10.0, 10.0, 10.0, 0.0],
                                        # [45.0, 10.0, 10.0, 10.0, 0.0],
                                        # [46.0, 10.0, 10.0, 10.0, 0.0],
                                        # [47.0, 10.0, 10.0, 10.0, 0.0],
                                        # [48.0, 10.0, 10.0, 10.0, 0.0],
                                        # [49.0, 10.0, 10.0, 10.0, 0.0],
                                        # [50.0, 10.0, 10.0, 10.0, 0.0]
                                        ])
    gt_bboxes = torch.tensor([[10.0, 10.0, 10.0, 10.0, 0.0]])                                 
    eps = 1e-7
    import numpy as np 
    import matplotlib.pyplot as plt
    
    x = np.linspace(10, 25, 16, endpoint=True)
    print(x)

    kld = kld_distance(valid_decoded_bbox, gt_bboxes)
    kld_ = -torch.log(kld + eps)
    
    kld_ = 30 / (1 + torch.exp(-5*(kld_-1)))
    kld_ = kld_.clamp(max=16)
    kld_ = kld_.squeeze().numpy()

    overlaps = rbbox_overlaps(valid_decoded_bbox, gt_bboxes)
    overlaps_ = -torch.log(overlaps + eps).squeeze().numpy()
    

    plt.figure(figsize=(10, 10), dpi=100)
    plt.plot(x, kld_, linestyle="solid", marker='v', c='red', label='kld')
    plt.plot(x, overlaps_, linestyle="-", marker='o', c='blue', label='iou')
    plt.title('') 
    plt.legend(loc='best', fontsize=14, markerscale=0.5)
    # plt.show()
    plt.savefig("/home/server4/mmrotate/figure/kld_exp30.jpg")
    print(kld)
    # print(overlaps)