...
class RSimOTAAssigner_gau(SimOTAAssigner):
    ...
    def __init__(self,
                 ...
                 gau_weight=8.0,
                 **kwargs):
        super(RSimOTAAssigner_gau, self).__init__(**kwargs)
    ...
    def _assign(self,
        ...
        cost_matrix = soft_cls_cost * self.cls_weight + iou_cost * self.iou_weight  + (1.0 - gau_dis) * self.gau_weight
