...
class FCOSRSimOTAAssigner(SimOTAAssigner):

    def __init__(self, angle_version='le90', **kwargs):
        super(FCOSRSimOTAAssigner, self).__init__(**kwargs)
