...
class RSimOTAAssigner_softlabel(SimOTAAssigner):

    def __init__(self, angle_version='le90', **kwargs):
        super(RSimOTAAssigner_softlabel, self).__init__(**kwargs)
    ...
    def _assign(self,
        ...
        cost_matrix = (
            soft_cls_cost * self.cls_weight + iou_cost * self.iou_weight +
